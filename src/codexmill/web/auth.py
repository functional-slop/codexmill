...
def build_oauth(oidc: OIDCConfig) -> Any:
    ...
    oauth.register(
        ...
        # PKCE (S256) even for this confidential client (RFC 9700): defends against auth-code
        # injection. Authlib generates/stores the verifier and validates state + nonce for us.
        client_kwargs={"scope": oidc.scope, "code_challenge_method": "S256"},
    )
    return oauth
