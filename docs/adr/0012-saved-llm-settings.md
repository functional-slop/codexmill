...
> **Secrets-at-rest superseded by [ADR 0024](0024-local-accounts.md):** encryption is now ALWAYS on
> with an auto-generated key — no longer opt-in / plaintext-without-the-env-var. The saved-LLM-settings
> + resolution-precedence decisions below still stand.
