...
> **Superseded in part by [ADR 0024](0024-local-accounts.md):** auth is now MANDATORY. The "gate the
> expensive action, leave the page open" posture below no longer holds — a fresh instance is closed and
> every route needs a session. OIDC stays optional, composing on top of the local account.
